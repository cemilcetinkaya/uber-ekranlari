...
class MyBookingsCanceled extends StatefulWidget {
  const MyBookingsCanceled({super.key});

  @override
  State<MyBookingsCanceled> createState() => _MyBookingsCanceledState();
}

class _MyBookingsCanceledState extends State<MyBookingsCanceled> {
  @override
